...
class MongoDBManagement:
    ...
    def __init__(self, username, password):
        ...
        try:
            ...
            self.url = "mongodb+srv://mongouser:mongouser@cluster0.clupd.mongodb.net/myFirstDatabase?retryWrites=true&w=majority".format(
             self.username, self.password)
    ...
    def closeMongoDBconnection(self):
        """
        This function closes the connection of client
        :return:
        """
        try:
            mc = self.getMongoDBClientObject()
            mc.close()
        except Exception as e:
